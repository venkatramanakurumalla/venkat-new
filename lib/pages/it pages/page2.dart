...
void main() => runApp(MyAllitsc2());
  
class MyAllitsc2 extends StatelessWidget {
  @override
...
//Applying get request.
  ...
  Future<List<User>> getRequest() async {
   ...
   // String url ="https://deaninstitute.fastrider.co/api/all-sub-category";
     String url="https://www.deaninstitute.fastrider.co/api/course-by-subcategory/2";
          ...
          children: [
           ...
           //  trailing: Image.network('https://deaninstitute.fastrider.co//'+snapshot.data[index].image),
            // trailing: Icon(Icons.book_online),
              onTap: () {
                      if(index==0){
                        Get.to(CourseDetailss(),arguments:[snapshot.data[index].image,snapshot.data[index].description]);
